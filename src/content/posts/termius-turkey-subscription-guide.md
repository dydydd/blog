...
| 项目 | 说明 | 获取方式 |
|------|------|----------|
| 土耳其 VPN / 代理 | IP 越干净越好，推荐专线节点 | 自行准备 |
| 迅游加速器 | 免费加速微软商店兑换 | 官网下载 |
| 土耳其礼品卡 | 给微软商店充值用的 | 淘宝搜"土耳其 微软礼品卡" |
| Termius 9.12.0.0 安装包 | **最关键的一步**，新版已修复土区定价 | 见原帖链接 |
| AppContainer Loopback Utility | 解除 Windows App 网络回环限制 | GitHub 开源工具 |
...
![Termius 土区订阅完整流程](./termius-turkey-subscription-guide.svg)

### 第一步：注册微软土耳其区账号

**这一步必须全程开土耳其代理。** IP 越干净越好，不容易被风控。

1. 访问 [微软账号注册页面](https://signup.live.com/)
2. 推荐用「Get a new email address」新建一个 Outlook 邮箱
3. 正常填写信息走注册流程

> ⚠️ **关键检查点：** 在生日选择页面，看一下右下角的「国家/地区」是不是默认显示 **Turkey（土耳其）**。如果不是，说明你的代理 IP 被识别到了其他国家，需要换一个土耳其节点重新来。
>
> 生日随便选，满 18 岁就行。
...
*本文改写自 [NodeSeek 论坛 @Lite 的教程](https://www.nodeseek.com/post-295429-1)，原作者耗时两周踩坑总结，在此致谢。*
